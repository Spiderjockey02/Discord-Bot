module.exports.run = async (bot, message, args, settings, ops) => {
	...
	if (message.member.voiceChannel !== message.guild.me.voiceChannel) return message.channel.send({ embed:{ color:15158332, description:`${bot.config.emojis.cross} Sorry, you currently aren't in the same channel as the bot.` } }).then(m => m.delete({ timeout: 5000 }));
