const languageData = {
  ...
  MODERATION_SET: (option) =>
    `Moderation plugin has been set to \`${option}\`.`,
  ...
  NO_LANGUAGE:
    "That is not a language I support, yet. Why not help me learn that language by joining here: https://discord.gg/8g6zUQu",
  ...
  EGGLORD_REACTIONS: "Egglord Reaction Roles",
