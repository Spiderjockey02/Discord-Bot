...
module.exports.run = async (bot, message, args, emojis, settings) => {
	const embed = new MessageEmbed()
		...
		.addField(message.translate(settings.Language, 'MISC/ABOUT_MEMBERS'), bot.users.cache.size, true)
		...
		.addField(message.translate(settings.Language, 'MISC/ABOUT_MESSAGES'), `${bot.Stats.MessageSent} messages\n${(bot.Stats.MessageSent / (bot.uptime / 1000)).toFixed(2)} msg/sec`, true)
