...
module.exports = class Pause extends Command {
	...
	async run(bot, message, settings) {
		...
		if (player.paused) return message.channel.error(settings.Language, 'MUSIC/ALREADY_PAUSED', settings.prefix);

		// Pauses the music
		player.pause(true);
		return message.channel.success(settings.Language, 'MUSIC/SUCCESFULL_PAUSE');
	}
};
